...
const BRAND = {
  ...
  logo:
    ...
    "https://raw.githubusercontent.com/shahariyar23/bloodBankApiData/refs/heads/main/image-removebg-preview.png",
  primary: "#C0392B",
  primaryDark: "#96231A",
  bg: "#F8F8F8",
  cardBg: "#FFFFFF",
    ...
    <tr>
      <td align="center">
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0"
          style="background-color:${BRAND.cardBg};border-radius:10px;overflow:hidden;
                 border:1px solid ${BRAND.border};max-width:600px;width:100%;">

          <tr>
            <td align="center"
              style="background-color:${BRAND.primary};padding:28px 32px;">
          ...
          <tr>
            <td align="center"
              style="background-color:#F2F2F2;border-top:1px solid ${BRAND.border};
                     padding:20px 32px;">
...
const ctaButton = (label: string, href: string) => `
  <table cellpadding="0" cellspacing="0" border="0" style="margin:20px 0;">
    <tr>
      <td align="center"
        style="background-color:${BRAND.primary};border-radius:6px;">
        <a href="${href}"
...
const infoRow = (label: string, value: string, highlight = false) => `
  <tr>
    <td style="padding:10px 14px;font-size:13px;font-weight:700;
               color:${BRAND.muted};background-color:#FAFAFA;
               border-bottom:1px solid ${BRAND.border};width:38%;
               border-right:1px solid ${BRAND.border};">
      ${label}
    </td>
    <td style="padding:10px 14px;font-size:14px;
               color:${highlight ? BRAND.primary : BRAND.text};
               font-weight:${highlight ? "700" : "400"};
               background-color:#FFFFFF;border-bottom:1px solid ${BRAND.border};">
      ${value}
    </td>
  </tr>
`;
...
const infoTable = (rows: string) => `
  <table width="100%" cellpadding="0" cellspacing="0" border="0"
    style="border:1px solid ${BRAND.border};border-radius:8px;
...
const alertBox = (text: string, color = BRAND.primary) => `
  <table width="100%" cellpadding="0" cellspacing="0" border="0"
    style="background-color:#FFF5F5;border-left:4px solid ${color};
...
export const emailVerificationOTPTemplate = (params: {
  ...
  baseTemplate(`
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      ...
      <tr>
        <td align="center"
          style="background-color:#FFF5F5;border:2px dashed ${BRAND.primary};
  ...
  baseTemplate(`
    ...
    ${para(`Or copy and paste this link into your browser:<br/>
      <a href="${params.resetLink}"
        style="color:${BRAND.primary};word-break:break-all;font-size:13px;">
        ${params.resetLink}
      </a>`)}
...
export const hospitalPasswordResetSuccessTemplate = (): string =>
  baseTemplate(`
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:20px;">
      <tr>
        <td align="center">
          <div style="width:64px;height:64px;background-color:#EAF7ED;border-radius:50%;
...
export const requestAlreadyFulfilledTemplate = (params: {
  ...
  baseTemplate(`
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0"
      style="background-color:#FFF5F5;border-radius:8px;margin:16px 0 24px;">
      <tr>
